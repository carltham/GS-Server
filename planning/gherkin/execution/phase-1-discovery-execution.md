...
| REST API | Hardening endpoint contract and error model | API contract/integration | Complete | GSServer-pom/GSServer-UI/src/test/java/com/gsserver/ui/hardening/HardeningControllerContractTest.java | Covers accepted contract, malformed JSON 400, policy-violation 422 payloads, and execution failure 500 payloads including rollback succeeded/failed message branches. |
